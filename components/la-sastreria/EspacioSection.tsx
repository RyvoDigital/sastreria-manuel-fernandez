      ...
      <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          >
            ...
            <img
              src="https://res.cloudinary.com/dp3qxlhb4/image/upload/photos/web_lista_images/sastreria-space-01_ucman9"
          ...
          <div style={{
            ...
            {[
              { src: 'https://res.cloudinary.com/dp3qxlhb4/image/upload/photos/web_lista_images/sastreria-space-02_wvinrk', alt: 'Taller de Sastrería Manuel Fernández' },
              { src: 'https://res.cloudinary.com/dp3qxlhb4/image/upload/photos/web_lista_images/sastreria-space-03_eh5jl3', alt: 'Taller de Sastrería Manuel Fernández' },
            ].map((photo, i) => (
              <div
                key={i}
