...
export function CraftJourneySection() {
  ...
  const sections = [
    {
      id:          'tejido',
      background:  '/img/tejido-principe-de-gales-etiqueta.webp',
    ...
    {
      id:          'diseno',
      background:  '/img/chaque-hilvanado-diseno.webp',
    ...
    {
      id:          'corte',
      background:  '/img/corte-a-mano-mesa.webp',
    ...
    {
      id:          'proceso',
      background:  '/img/cosido-a-mano-detalle.webp',
