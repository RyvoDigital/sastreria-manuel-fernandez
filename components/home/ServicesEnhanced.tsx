...
const SERVICES = [
  {
    ...
    icon: Scissors,
    href: '/la-sastreria',
    image: '/img/manuel-fernandez-toma-medidas-cliente.webp',
  ...
  },
  {
    ...
    href: '/bodas-y-ceremonia',
      image: '/img/novia-velo-novio-jardin.webp',
    settingId: 'bodas',
  },
  {
  ...
  },
  {
    ...
    icon: GraduationCap,
    href: '/cursos',
    image: '/img/herramientas-sastre-cinta-metrica.webp',
    settingId: 'cursos',
  },

  {
    ...
    icon: Mail,
    href: '/contacto',
    image: '/img/clientes-showroom-sofa.webp',
    settingId: 'contacto',
  },
]
