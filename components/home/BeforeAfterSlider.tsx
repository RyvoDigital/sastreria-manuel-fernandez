      ...
      <div style={{
        ...
        >
          ...
          <div style={{ position: 'absolute', inset: 0 }}>
            ...
            <img
              src="https://res.cloudinary.com/dp3qxlhb4/image/upload/v1778764178/photos/camel-jacket-form_bcc78q.jpg"
              alt="After fitting"
              style={{
                width: '100%',
                height: '100%',
          ...
          >
            <img
              src="https://res.cloudinary.com/dp3qxlhb4/image/upload/v1778764147/photos/fitting-vest_c6seil.jpg"
              alt="Before fitting"
              style={{
                width: '100%',
                height: '100%',
