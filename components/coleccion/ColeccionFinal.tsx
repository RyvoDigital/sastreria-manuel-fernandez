...
export function ColeccionFinal() {
  const { t } = useI18n()
  ...
  return (
    ...
    >
      ...
      <div style={{
        position: 'absolute', inset: 0,
        background: 'linear-gradient(to bottom, rgba(5,12,20,0.55) 0%, rgba(5,12,20,0.7) 100%)',
      }} />

      {/* Content */}
      <div
        className="mf-cf-content"
        style={{
          position: 'relative',
          zIndex: 1,
          textAlign: 'center',
