...
const CATS = [
  { src: '/photos/camel-jacket-form.jpg',    height: '46vh', key: 'cat1' as const },
  { src: '/photos/showroom-jackets.jpg',     height: '63vh', key: 'cat2' as const },
  { src: '/photos/gray-check-mannequin.jpg', height: '46vh', key: 'cat3' as const },
]

export function ColeccionCategorias() {
  const { t } = useI18n()
  const c = t.coleccion.categorias
        ...
        {CATS.map(({ src, height, key }) => (
          ...
          >
            ...
            <div style={{
              ...
              background: 'linear-gradient(to top, rgba(5,12,20,0.85) 0%, rgba(5,12,20,0.4) 50%, transparent 100%)',
            }} />
            {/* Text */}
            <div style={{
