...
export function ColeccionEditorial() {
  const { t } = useI18n()
  const c = t.coleccion.editorial
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <img
            src="/photos/atelier-workshop.jpg"
            alt="El oficio del sastre"
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover',
      ...
      >
        ...
        <div style={{
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/photos/mint-jacket-madrid.jpg"
            alt="El resultado del sastre"
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover',
